module.exports = {
    ...
    clientLibRoot: "./../ui.apps/src/main/content/jcr_root/apps/blueprint-uikit/clientlibs",

    libs: [
        {
            name: "clientlib-dependencies",
            allowProxy: true,
            categories: ["blueprint-uikit.dependencies"],
        ...
        },
        {
            name: "clientlib-site",
            allowProxy: true,
            categories: ["blueprint-uikit.site"],
            dependencies: ["blueprint-uikit.dependencies"],
            serializationFormat: "xml",
            cssProcessor : ["default:none", "min:none"],
            jsProcessor: ["default:none", "min:none"],
            assets: {
